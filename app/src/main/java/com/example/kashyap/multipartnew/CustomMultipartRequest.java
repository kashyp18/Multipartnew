...
public class CustomMultipartRequest extends Request<JSONObject> {
   ...
   // private final Map<String, String> mStringPart;
    ...
    public CustomMultipartRequest(String url, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener, Map<String, File> mFilePartData, Map<String, String> mHeaderPart) {
...
**/
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        System.out.println("headers"+mHeaderPart.toString());
        return mHeaderPart;
    }
